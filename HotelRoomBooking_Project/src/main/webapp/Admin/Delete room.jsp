...
<div class="col-md-9"><h1 ">Room Details</h1>
<center>
<form action="Delete_roomdb.jsp" method="post">
<fieldset style="color: green;background-color: pink">
<div class="w3_wthree_agileits_icons main-grid-border">
<table id="customers" border=1>
<tr><th>ROOM ID</th><th>ROOM TYPE</th><th>LOCATION</th><th>PRICE PER DAY</th><th>ADDRESS</th><th>SELECT</th><th>DELETE</th></tr>
...
<%
	...
	<td><input type="radio" name="room" value="<%=rs.getString(1) %>"></td>

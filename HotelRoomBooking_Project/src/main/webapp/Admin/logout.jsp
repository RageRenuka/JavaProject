			...
			<div class="header">
				<div class="container">
					<div class="w3_agile_logo">
						<h1><a href="index.html"><span width ="20px">Dream Hotel </span></a></h1>
					</div>
							...
							<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
								<nav class="link-effect-12">
									<ul class="nav navbar-nav w3_agile_nav">
										...
										<li><a href="Update room.jsp.jsp"><span>Update Room</span></a></li>							
...
<div class="w3_wthree_agileits_icons main-grid-border"><br><br>
		<div class="container">

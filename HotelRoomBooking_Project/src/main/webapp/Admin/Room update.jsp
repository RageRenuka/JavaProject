...
<%                  
					...
					PreparedStatement ps=con.prepareStatement("select * from `addroom` where roomid=?");
					ps.setString(1, roomid);
					ResultSet rs=ps.executeQuery();
					while(rs.next()){	%>


    <form class="well form-horizontal" action="Room_updatedb.jsp" method="post"  id="contact_form" autocomplete="off">
<fieldset style="color: red;background-color: pink">
<!-- Text input-->
...
<div class="form-group">
    ...
    <div class="input-group">
        <span class="input-group-addon"></span>
  		<input  type="text" class="form-control" name="roomid" placeholder="Enter Room Id" value="<%=rs.getString(1) %>"  >
    </div>
  </div>
  </div>
...
<%-- <div class="form-group">
    ...
    <div class="input-group">
        <span class="input-group-addon"></span>
  <input name="roomid" placeholder="Enter Price Per Day" class="form-control"  type="text" value="<%=rs.getString(1) %>" >
    </div>
  </div>
</div> --%>
 ...
 <div class="form-group"> 
  <label class="col-md-4 control-label">Room Type</label>
    ...
    <select name="roomtype" class="form-control selectpicker">
      <option value="<%=rs.getString(2) %>">--Select--</option>
  ...
  <label class="col-md-4 control-label">No.Of Rooms</label>
    ...
    <select name="no_of_rooms" class="form-control selectpicker">
      <option value="<%=rs.getString(3) %>">--Select--</option>
      <option>1</option>
      <option>2</option>
      <option>3</option>
      <option>4</option>
  ...
  <label class="col-md-4 control-label">Location</label>
    ...
    <select name="location" class="form-control selectpicker">
      <option value="<%=rs.getString(4) %>">--Select--</option>
  ...
  <div class="form-group">
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  		 <input name="price_per_day" placeholder="Enter Price Per Day" class="form-control" value="<%=rs.getString(5) %>" type="text">
    </div>
  </div>
  </div>
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"></span>
  <textarea rows="3" cols="39" name="address" placeholder="Enter Address" value="<%=rs.getString(6) %>"  ></textarea>
    </div>
  </div>
</div>

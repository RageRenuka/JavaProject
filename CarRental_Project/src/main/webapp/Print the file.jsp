...
<div>
<h1  style="color:Blue;align:center"><font face="Algerian">CAR RENTAL</font></h1>
</div>
<form action="" method="post">
<table>
Name:<input type="text" name = "name" value="name">&nbsp;&nbsp; Book Date:<input type="text" name="bdate" value=""><br><br>
Car Number:<input type="text" name="cno" value="carno"><br><br>
From Date:<input type="text" name ="fdate" value="fdate">&nbsp;ToDate:<input type="text" name="tdate" value=""><br><br>
Total Amount:<input type="text" name="tamount" value="">/-<br><br>
<td style="margin-left: 500px;"> Receives Signature</td>
</table>
</form>
</body>
</html>

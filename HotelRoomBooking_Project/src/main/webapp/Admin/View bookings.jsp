...
<!-- header -->
	...
	<!-- icons -->
<div class="container">
<form class="well form-horizontal" action="Booking delete.jsp" method="post"  id="contact_form" autocomplete="off">

<fieldset style="color: green;background-color: pink">
<div class="w3_wthree_agileits_icons main-grid-border">
		<div class="container">
			<div class="w3ls-heading">
				<h2>View Bookings</h2><br>
			</div></div>						  
			<!-- Text input-->
...
{ 
  ...
  <tr>
									...
									<td><input type="radio" value=<%=rs.getString("bookid")%> name="bookid"></td>
